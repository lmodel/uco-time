# Contributing to uco-time

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to uco-time. 
...
The uco-time team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/uco-time/issues/) for reporting problems with the ontology. 
